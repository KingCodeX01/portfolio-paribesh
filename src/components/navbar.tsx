...
const Navbar = () => {
  ...
  return (
    <div className="w-20 bg-[#2C2D32] h-[100vh] max-lg:w-full max-lg:h-20 max-lg:flex max-lg:items-center max-lg:justify-between max-lg:px-4">
      <div className="w-full h-full flex flex-col max-lg:flex-row max-lg:items-center max-lg:justify-between relative">
        {/* Profile Image */}
        ...
        {/* Menu Button */}
        <div className="p-2 flex items-center justify-center w-full max-lg:w-auto">
          <button
          ...
          >
            ...
            <p className="max-lg:hidden">MENU</p>
          </button>
        </div>
        ...
        {/* Social Links */}
        <div className="absolute bottom-20 left-3 flex flex-col items-center justify-center p-2 max-lg:relative max-lg:bottom-auto max-lg:left-auto max-lg:flex-row max-lg:space-x-4">
          <ul className="flex flex-col space-y-2 max-lg:flex-row max-lg:space-x-4 max-lg:space-y-0">
            <li className="w-18 border-gray-600 border p-2 transition-all delay-300 ease-out hover:rounded-full hover:text-white">
              <a
        ...
        {/* Share Button */}
        <div className="absolute bottom-0 w-full flex items-center justify-center max-lg:relative max-lg:w-auto">
          <button
            onClick={copyToClipboard}
            className="bg-yellow-300 w-full p-4 text-white text-2xl max-lg:w-auto max-lg:px-4 max-lg:py-2"
          >
